...
class CdwaLite
  ...
  attr_accessor :accession_number, :title, :creator, :date, :materials, :description,
  ...
  def create_from_paths
    ...
    @accession_number = xpath('cdwalite:cdwalite//cdwalite:workID[@cdwalite:type="accession"]/text()')
